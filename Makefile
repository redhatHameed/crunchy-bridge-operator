...
# crunchybridge.com/crunchy-bridge-operator-bundle:$VERSION and crunchybridge.com/crunchy-bridge-operator-catalog:$VERSION.
#relplace with your org name for example: quay.io/crunchydata/crunchy-bridge-operator
